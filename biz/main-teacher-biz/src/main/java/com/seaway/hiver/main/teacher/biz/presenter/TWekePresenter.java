...
public class TWekePresenter extends CommonLoginPresenter<TWekeContract.View, IMainTeacherDataSource> implements TWekeContract.Presenter {

    public TWekePresenter(TWekeContract.View view) {
        super(view);
